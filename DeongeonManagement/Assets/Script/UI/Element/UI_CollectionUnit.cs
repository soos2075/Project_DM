...
public class UI_CollectionUnit : UI_Base
{
    ...
    void SelectUnit()
    {
        ...
        else if (Data_BattleStatus != null)
        {
            mainUI.ShowBox_BattleStatus(Data_BattleStatus);
        }
    ...
    CollectionManager.CollectionUnitRegist<SO_BattleStatus> Data_BattleStatus;
    ...
    public void SetUnit_BattleStatus(CollectionManager.CollectionUnitRegist<SO_BattleStatus> data, UI_Collection parent)
    {
        InitAndSetData(parent);
