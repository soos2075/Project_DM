...
public class UI_StatusUp : UI_PopUp
{
    ...
    {
        SetStateText($"{UserData.Instance.LocaleText("New")}{UserData.Instance.LocaleText("특성")} : <b>{GameManager.Trait.GetData(traitName).labelName}</b>");
    }
    ...
    void StatusComparison()
    {
        ...
        else if (before_lv > after_lv)
        {
            ...
            show_lv += $" ▼{Mathf.Abs(after_lv - before_lv)}".SetTextColorTag(Define.TextColor.npc_red);
        }
        ...
        else if (before_hp > after_hp)
        {
            ...
            show_hp += $" ▼{Mathf.Abs(after_hp - before_hp)}".SetTextColorTag(Define.TextColor.npc_red);
        }
        ...
        else if (before_atk > after_atk)
        {
            ...
            show_atk += $" ▼{Mathf.Abs(after_atk - before_atk)}".SetTextColorTag(Define.TextColor.npc_red);
        }
        ...
        else if (before_def > after_def)
        {
            ...
            show_def += $" ▼{Mathf.Abs(after_def - before_def)}".SetTextColorTag(Define.TextColor.npc_red);
        }
        ...
        else if (before_agi > after_agi)
        {
            ...
            show_agi += $" ▼{Mathf.Abs(after_agi - before_agi)}".SetTextColorTag(Define.TextColor.npc_red);
        }
        ...
        else if (before_luk > after_luk)
        {
            ...
            show_luk += $" ▼{Mathf.Abs(after_luk - before_luk)}".SetTextColorTag(Define.TextColor.npc_red);
        }
    }
